 ...
 */
public class PunctuationProcessor implements Processor<Character> {
	final Atom tokenAtom = new PunctuationAtom();
	...
	{
		return Optional.of(new Token(buf.toString(), TokenType.PUNCTUATION));
	}
